...
void Camera::update_aspect() {
    data.project = glm::perspective(glm::radians(60.0f), (float) Match::runtime_setting->window_size.width / (float) Match::runtime_setting->window_size.height, 0.1f, 100.0f);
}
